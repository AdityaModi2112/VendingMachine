    ...
    return(
        <div id='foot'>
            ...
            <div id='footerleft'>
                ...
                <div>
                    <p><img className="hoverable-element" src='location.png' alt='not available'/> Appen your address here</p>
                    <p><img className="hoverable-element" src='location.png' alt='not available'/> info@gmail.com</p>
                    <p><img className="hoverable-element" src='location.png' alt='not available'/>+919999999999</p>
                </div>
            </div>
            <div id="footerright">
